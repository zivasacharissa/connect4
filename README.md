...
* Move the class NameAI from the com.thg.accelerator23.connectn.ai.Connect4CaptainsMistress package to replace yourteam with the name of your team (lowercase). 
